...
class UserViewSet(mixins.CreateModelMixin, BaseGenericViewSet):
    ...
    def get_serializer_class(self):
        ...
        elif self.action == "get_other_token":
            return GetOtherTokenSerializer
    ...
    @action(methods=['get'], detail=False)
    def get_other_token(self, request):
        serializer = self.get_serializer(data={"auth_code": request.query_params.get('auth_code'),
