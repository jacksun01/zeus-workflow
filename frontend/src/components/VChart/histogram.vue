<template>
  <ve-histogram :title="attrs.title" :data="chartData" :url="url" :width="attrs.width" :height="attrs.height" :settings="settings" :extend="extend"></ve-histogram>
</template>

<script>
  import request from '@/utils/request'
  export default {
    name: 'VChartHistogram',
    props: {
      url: {
        type: String,
      },
