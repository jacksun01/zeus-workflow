...
export const User = {
  ...
  //双因子认证
  otp() {return request.get(`${UserUrl}/otp/`).then(response => {return response.data})},
  otp_recovery_codes() {return request.get(`${UserUrl}/otp_recovery_codes/`).then(response => {return response.data})},
  otp_login(params) {return request.post(`${UserUrl}/otp_login/`, params).then(response => {return response.data})},
  otp_recovery_login(params) {return request.post(`${UserUrl}/otp_recovery_code_login/`, params).then(response => {return response.data})},
  otp_disable(params) {return request.post(`${UserUrl}/otp_disable/`, params).then(response => {return response.data})},
  otp_enable(params) {return request.post(`${UserUrl}/otp_enable/`, params).then(response => {return response.data})},
}
